...
router.post('/', [(0, express_validator_1.check)('req.body', 'El Body no se encuentra presente en la petición').exists()], util_1.validateToken, client_controller_1.postCliente);
router.put('/', [(0, express_validator_1.check)('req.body', 'El Body no se encuentra presente en la petición').exists()], util_1.validateToken, client_controller_1.putCliente);
